...
public interface ScheduleService {
    ...
    List<ScheduleResponseDTO> searchSchedules(Timestamp departureTime, Integer departureAirportId, Integer arrivalAirportId, Integer airlineId, String className, Integer totalPerson);
